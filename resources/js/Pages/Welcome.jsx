                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mb-40">
                            ...
                            <div className="button relative flex justify-center items-start bg-white h-20">
                                <button className="absolute -top-10  text-xl   p-20 py-5 rounded-3xl shadow-lg   bg-primary text-white  font-medium">
                                    Buat Laporan
                                </button>
                            </div>
                            <div className="history my-10">
                                <div className="container mx-auto">
                                    <div className="header text-black flex justify-between px-10 items-center my-10">
                                        ...
                                        <a
                                            href=""
                                            className="text-primary_600 text-xl"
                                        >
                                            Liat Semua
                                        </a>
                                    </div>
                                    <div className="content">
                                        <div className="container mx-auto px-10">
                                            <ul>
                                                <li className="font-medium text-black text-xl flex bg-primary_200 py-10 px-10 rounded-3xl my-3">
                            ...
                            <div className="history my-10">
                                <div className="container mx-auto">
                                    <div className="header text-black flex justify-between px-10 items-center my-10">
                                        ...
                                        <a
                                            href=""
                                            className="bg-[#EAFDF9] text-xl h-16 w-16 rounded-full flex justify-center items-center"
                                        >
                                            <svg
                                                width="23"
                                                height="22"
                                            ...
                                            >
                                                <path
                                                    d="M8.34999 4.80015L14.65 11.1001L8.34999 17.4001"
                                                    stroke="#13AC8A"
                                                    stroke-width="1.35"
                                        ...
                                        <div className="container mx-auto px-10">
                                            <ul className="grid grid-cols-2 gap-4">
                                                <li>
                                                    <a
                                                        href=""
                                                        className="font-medium text-black text-xl flex flex-col bg-white shadow-lg rounded-3xl my-3 overflow-hidden"
                                                    >
                                                        <img
                                                            src="/img/news2.jpeg"
                                                            alt=""
                        ...
                        <footer>
                            <div className="container relative mx-auto px-10 ">
                                <nav className="py-5 bg-white fixed bottom-0 w-[72rem] shadow-inner ">
